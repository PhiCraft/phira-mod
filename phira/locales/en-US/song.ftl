...
mods-full-screen-judge-sub = Notes can be hit anywhere on the screen, not only near their own position. *YOU CAN'T UPLOAD SCORES WITH THIS MOD ENABLED*
mods-health-mode = Health Mode
mods-health-mode-sub = Perfect / Good heals, Bad / Miss damages, every 10 combo heals a bit more, and running out of health fails the play. *YOU CAN'T UPLOAD SCORES WITH THIS MOD ENABLED*
