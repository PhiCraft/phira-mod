...
mods-full-screen-judge-sub = 屏幕上任意位置都能判定到音符，不再要求点在自己的位置上。*启用此 Mod 后无法上传成绩*
mods-health-mode = 血条模式
mods-health-mode-sub = Perfect / Good 回血，Bad / Miss 扣血，每 10 连击额外回血，血量归零即失败。*启用此 Mod 后无法上传成绩*
